...
local open E.DSL
in
val () = ex {name="ex1", e=ln (sin x1), arg=V.R 3.0, d=V.R 1.0,
             expected=SOME(V.R ~1.95814462961,V.R ~7.01525255143)}

val () = ex {name="ex2", e=x1*x2, arg=V.T[V.R 3.0,V.R 1.0], d=V.R 1.0,
             expected=SOME(V.R 3.0, V.T[V.R 1.0,V.R 3.0])}

val () = ex {name="ex3", e=ln x1 + x1*x2 - sin x2, arg=V.T[V.R 3.0,V.R 1.0], d=V.R 1.0,
